  ...
  <el-header class="douyin-header">
    <div class="douyin-logo">
      <el-menu :ellipsis="false" mode="horizontal">
        <el-menu-item index="1" @click="goto('download')"
          >下载客户端</el-menu-item
        >
        <!-- router指定路由，@click点击事件 -->
        <el-menu-item index="2" @click="goto('recharge')"
          >充值金币</el-menu-item
        >
        <el-menu-item index="3" @click="goto('notify')"
          ><el-badge :value="12">消息通知</el-badge></el-menu-item
        >
      </el-menu>
    </div>
    <div class="douyin-nav">
      <div class="user-info" v-if="isLoggedIn">
        ...
        <el-button type="info" class="logout-button" @click="handleLogout"
          >退出登录</el-button
        >
      </div>
      <el-button
